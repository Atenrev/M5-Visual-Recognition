...
def run_experiment(train_dataloader, test_dataloader, model, embed_size, n_neighbors=50):
    device = 'cuda'
...
def main(args: argparse.Namespace):
    ...
    train_ds, test_ds = create_mit_dataloader(
        1, '../datasets/MIT_split/', dataset_config, inference=False)
    ...
    run_experiment(train_ds, test_ds, model,
                   args.embedding_size, args.n_neighbors)
